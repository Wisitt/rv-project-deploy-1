import{R as K,r as a,_ as Y,X as te,c as T,j as k,a0 as be,b4 as ne,$ as Ie,a2 as ce,aC as Oe,Z as Ue}from"./index-d3b06103.js";import{s as oe,u as ge}from"./styled-cc5b2fa7.js";import{u as H}from"./useEventCallback-0e03fb6b.js";function Q(e,o){return Q=Object.setPrototypeOf?Object.setPrototypeOf.bind():function(l,t){return l.__proto__=t,l},Q(e,o)}function ze(e,o){e.prototype=Object.create(o.prototype),e.prototype.constructor=e,Q(e,o)}const pe=K.createContext(null);function Xe(e){if(e===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e}function ie(e,o){var s=function(n){return o&&a.isValidElement(n)?o(n):n},l=Object.create(null);return e&&a.Children.map(e,function(t){return t}).forEach(function(t){l[t.key]=s(t)}),l}function Ke(e,o){e=e||{},o=o||{};function s(d){return d in o?o[d]:e[d]}var l=Object.create(null),t=[];for(var n in e)n in o?t.length&&(l[n]=t,t=[]):t.push(n);var i,c={};for(var u in o){if(l[u])for(i=0;i<l[u].length;i++){var p=l[u][i];c[l[u][i]]=s(p)}c[u]=s(u)}for(i=0;i<t.length;i++)c[t[i]]=s(t[i]);return c}function L(e,o,s){return s[o]!=null?s[o]:e.props[o]}function Ye(e,o){return ie(e.children,function(s){return a.cloneElement(s,{onExited:o.bind(null,s),in:!0,appear:L(s,"appear",e),enter:L(s,"enter",e),exit:L(s,"exit",e)})})}function Ae(e,o,s){var l=ie(e.children),t=Ke(o,l);return Object.keys(t).forEach(function(n){var i=t[n];if(a.isValidElement(i)){var c=n in o,u=n in l,p=o[n],d=a.isValidElement(p)&&!p.props.in;u&&(!c||d)?t[n]=a.cloneElement(i,{onExited:s.bind(null,i),in:!0,exit:L(i,"exit",e),enter:L(i,"enter",e)}):!u&&c&&!d?t[n]=a.cloneElement(i,{in:!1}):u&&c&&a.isValidElement(p)&&(t[n]=a.cloneElement(i,{onExited:s.bind(null,i),in:p.props.in,exit:L(i,"exit",e),enter:L(i,"enter",e)}))}}),t}var We=Object.values||function(e){return Object.keys(e).map(function(o){return e[o]})},He={component:"div",childFactory:function(o){return o}},re=function(e){ze(o,e);function o(l,t){var n;n=e.call(this,l,t)||this;var i=n.handleExited.bind(Xe(n));return n.state={contextValue:{isMounting:!0},handleExited:i,firstRender:!0},n}var s=o.prototype;return s.componentDidMount=function(){this.mounted=!0,this.setState({contextValue:{isMounting:!1}})},s.componentWillUnmount=function(){this.mounted=!1},o.getDerivedStateFromProps=function(t,n){var i=n.children,c=n.handleExited,u=n.firstRender;return{children:u?Ye(t,c):Ae(t,i,c),firstRender:!1}},s.handleExited=function(t,n){var i=ie(this.props.children);t.key in i||(t.props.onExited&&t.props.onExited(n),this.mounted&&this.setState(function(c){var u=Y({},c.children);return delete u[t.key],{children:u}}))},s.render=function(){var t=this.props,n=t.component,i=t.childFactory,c=te(t,["component","childFactory"]),u=this.state.contextValue,p=We(this.state.children).map(i);return delete c.appear,delete c.enter,delete c.exit,n===null?K.createElement(pe.Provider,{value:u},p):K.createElement(pe.Provider,{value:u},K.createElement(n,c,p))},o}(K.Component);re.propTypes={};re.defaultProps=He;const Ge=re;function qe(e){const{className:o,classes:s,pulsate:l=!1,rippleX:t,rippleY:n,rippleSize:i,in:c,onExited:u,timeout:p}=e,[d,g]=a.useState(!1),b=T(o,s.ripple,s.rippleVisible,l&&s.ripplePulsate),E={width:i,height:i,top:-(i/2)+n,left:-(i/2)+t},h=T(s.child,d&&s.childLeaving,l&&s.childPulsate);return!c&&!d&&g(!0),a.useEffect(()=>{if(!c&&u!=null){const R=setTimeout(u,p);return()=>{clearTimeout(R)}}},[u,c,p]),k.jsx("span",{className:b,style:E,children:k.jsx("span",{className:h})})}const Ze=be("MuiTouchRipple",["root","ripple","rippleVisible","ripplePulsate","child","childLeaving","childPulsate"]),m=Ze,Je=["center","classes","className"];let G=e=>e,fe,de,he,me;const ee=550,Qe=80,et=ne(fe||(fe=G`
  0% {
    transform: scale(0);
    opacity: 0.1;
  }
